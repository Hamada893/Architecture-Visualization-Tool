  ...
  return (
    <StyledWrapper>
      <div className="centralize">
        <div>
          <button>
            <span><svg width={12} height={12} fill="#0E418F" xmlns="http://www.w3.org/2000/svg" shapeRendering="geometricPrecision" textRendering="geometricPrecision" imageRendering="optimizeQuality" fillRule="evenodd" clipRule="evenodd" viewBox="0 0 467 512.22">
